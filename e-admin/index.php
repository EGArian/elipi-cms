...
require_once str_replace ( '\\', '/', dirname ( dirname ( __FILE__ ) ) ) . '/inc/m-login.php';
session_start ();

if (! isset ( $_SESSION ['validate'] )) {
    if (isset ( $_POST ['username'], $_POST ['password'] )) {
        $login = new login ();
        $result = $login->check_user ( $_POST ['username'], $_POST ['password'] );
        if ($result) {
            echo '<div class="container theme-showcase">  <div class="alert alert-success">
        <center> <strong>متاسفیم !</strong> شما مجوز ورود ندارید  .
      </center> </div></div>';
            $result = $login->is_admin ( $_POST ['username'], $_POST ['password'] );
            if ($result) {
                $_SESSION ['validate'] = MakeHash ( $_POST ['password'] );
                $_SESSION['user']=$_POST ['username'];
                Redirect ( ADDRESS . 'e-admin/index.php' );
            } else {
                echo '<div class="container theme-showcase">  <div class="alert alert-success">
        <center> <strong>Well done!</strong>user not mod.
      </center> </div></div>';
            }
        } else {
            echo '<div class="container theme-showcase">  <div class="alert alert-danger">
        <center><strong>Well done!</strong> sorry your username or passowrd is wrong .
     </center> </div></div>';
        }
    }
...
<head>
<meta charset="utf-8" />
<link href="<?php echo ADDRESS; ?>e-admin/css/bootstrap.rtl.css"
	rel="stylesheet" />
<link href="<?php echo ADDRESS; ?>e-admin/css/font-awesome.css"
	rel="stylesheet" />
<link href="<?php echo ADDRESS; ?>e-admin/css/signin.css"
	rel="stylesheet" />
</head>
<body>
	<div class="container">
		...
		<form class="form-signin" action="" method="post">
			...
			<h2>
				<span class="fa fa-user"></span> لطفاً وارد شوید
			</h2>

			<input type="text" class="form-control" placeholder="نام کاربری"
				autofocus name="username"><br> <input type="password"
				class="form-control" placeholder="کلمه ی عبور" name="password">
			<button class="btn btn-lg btn-primary btn-block" type="submit">ورود
				به سایت</button>
		</form>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="index.php"><i
							class="fa fa-dashboard fa-2x"></i> مدیریت</a></li>
							<li><a href="#"><i class="fa fa fa-pencil-square-o fa-2x"></i>مدیریت مطالب</a>
						<ul class="nav nav-second-level">
							<li><a href="post.php">ارسال مطلب</a></li>
							<li><a href="#">ویرایش مطالب</a></li>

						</ul></li>
					<li><a href="category.php"><i class="fa fa-desktop fa-2x"></i>موضوعات</a></li>
					<li><a href="users.php"><i class="fa fa-users fa-2x"></i>
							کاربران</a></li>
					<li><a href="chart.html"><i class="fa fa-bar-chart-o fa-3x"></i>
							Morris Charts</a></li>
					<li><a href="table.html"><i class="fa fa-table fa-3x"></i> Table
							Examples</a></li>
					<li><a href="form.html"><i class="fa fa-edit fa-3x"></i> Forms </a>
					</li>
			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<h5><?php echo '  خوش آمدید  '.  Escape($_SESSION['user'])?></h5>
					</div>
				</div>
				<!-- /. ROW  -->
				<hr />
							...
							<div class="panel-body">
								<ul class="chat-box">
									<li class="left clearfix"><span class="chat-img pull-left"> <img
											src="assets/img/1.png" alt="User" class="img-circle" />
									</span>
										<div class="chat-body">
									...
									<li class="left clearfix"><span class="chat-img pull-left"> <img
											src="assets/img/3.png" alt="User" class="img-circle" />
									</span>
										<div class="chat-body clearfix">
